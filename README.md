# Neil's Pack <p>![GitHub release (latest by date including pre-releases)](https://img.shields.io/github/v/release/neilrush/neils-pack?include_prereleases&logo=github)
